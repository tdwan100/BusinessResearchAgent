    ...
    def run_opportunity_stage(
        ...
        task = Task(
            description=(
                ...
                "Include practical KPIs and implementation constraints. For each opportunity, "
                "use action-first phrasing and explicitly state the first implementation step.\n"
                "Return valid JSON matching this schema exactly: "
    ...
    def run_report_stage(
        ...
        task = Task(
            description=(
                ...
                "one sentence in 'executive_summary' stating that recommendations were generated "
                "using a multi-agent AI workflow, written for business readers without jargon. "
                "a dedicated 'recommended_first_automation_pilot' section that is highly concrete: "
                "name one workflow, describe current state friction, spell out the exact first "
                "implementation, and quantify expected time savings or economic impact ranges with "
                "bold percentages. Format the pilot section exactly with these headings: "
                "'Workflow', 'Current State', 'Proposed System', 'Expected Impact', and "
                "'Why This First'. Keep each subsection concise and use bullet points for each line. "
                "In 'Expected Impact', include phrasing like 'Reduce manual effort by 60–80%' so "
                "it can be emphasized as a key result. "
                "For 'ai_automation_opportunities', use prescriptive wording that emphasizes "
                "what should be done first rather than purely descriptive language, and format that "
                "section as bullet points. "
                "Use practical assumptions and uncertainty language where needed.\n"
                "Return valid JSON matching this schema exactly: "
